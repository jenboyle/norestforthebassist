...
ResultSet rsNotes = stmt.executeQuery("select * from notes where id=2");
...
ResultSet rsChords = stmt.executeQuery("select * from chords where id=2");
while(rsChords.next()) {
...
ResultSet rsChordTones = stmt.executeQuery("select * from chord_tones where id=2");
...
<table>
<tr>
<td><div class="left_arrow"><img src="resources/images/scrollleft.png" onclick="previousScale('dmajor')"></div></td>
<td>
                <div class="scalebassscore">
                    <img src="resources/images/bassscore.png" alt="D Major Scale" class="imgscalebassscore">
                ...
                <td><div class="right_arrow"><img src="resources/images/scrollright.png" onclick="nextScale('dmajor')"></div></td>
</tr>
</table>
                <table>
                    <tr>
